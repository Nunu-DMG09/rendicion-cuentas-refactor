                            ...
                            participantes.map((p, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        ...
                                        `}>
                                            {p.tipo === 'orador' ? 'Orador' : 'Asistente'}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-4 py-3 text-gray-600 max-w-[200px]">
                                        <span className="truncate block" title={p.organizacion || '-'}>
                                            {p.organizacion || '-'}
                                        </span>
                                    </td>
                                    <td className="px-4 py-3 text-center">
                                        ...
                                        `}>
                                            <span className={`w-1.5 h-1.5 rounded-full ${
                                                p.asistencia === "si" ? 'bg-green-500' : 'bg-red-500'
                                            }`} />
                                            {p.asistencia === "si" ? 'Sí' : 'No'}
                                        </span>
                                    </td>                                    
                                    <td className="px-4 py-3 text-center">
                                        {p.eje ? (
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        {p.pregunta ? (
                                            <motion.button
                                                ...
                                                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary-dark text-white rounded-lg text-xs font-medium hover:bg-primary transition-colors cursor-pointer"
                                                whileHover={{ scale: 1.05 }}
                                                whileTap={{ scale: 0.95 }}
                                            >
