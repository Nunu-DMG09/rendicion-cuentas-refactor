...
export const HistorialErrorState = ({ error, onRetry }: Props) => {
    ...
    return (
        ...
        >
            ...
            <h3 className="text-3xl font-titles font-bold text-gray-900 mb-4">
                {isNetworkError ? "Error de conexión" : "Error al cargar historial"}
            </h3>
            <p className="text-gray-600 text-lg font-body mb-8 max-w-md mx-auto">
                {isNetworkError
                    ? "Verifica tu conexión a internet e intenta nuevamente."
                    : "Ocurrió un problema al obtener el historial. Intenta nuevamente."}
            </p>
            <Button
                onClick={onRetry}
                variant="primary"
