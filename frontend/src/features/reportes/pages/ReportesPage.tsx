		...
		>
			<header>
				...
				<p className="text-gray-600 font-body text-lg mt-1">
					Consulta el reporte de participantes por rendición
				</p>
			</header>
			<motion.div
					...
					<div className="bg-linear-to-r from-primary-dark to-primary rounded-xl p-4 flex items-center justify-between">
						<div className="text-white">
							<h2 className="text-xl font-bold">
								{reportData?.rendicion.titulo ??
									`Rendición ${selectedRendicion}`}
							</h2>
							<p className="text-blue-100 text-sm">
								{formatDateWithWeekday(
									reportData?.rendicion.fecha ?? ""
								)}
							</p>
						</div>
					</div>
						...
						!isLoading && (
							...
							>
								...
								<p className="text-gray-600 font-body text-lg">
									Esta rendición no tiene participantes
									registrados.
								</p>
							</motion.div>
						)
			...
			<PreguntaModal modal={modal} onClose={closePreguntaModal} />
		</motion.div>
	);
}
