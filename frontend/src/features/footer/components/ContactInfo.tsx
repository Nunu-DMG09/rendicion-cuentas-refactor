    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
                <svg className="h-5 w-5 text-blue-300 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {contact.phone && (
                <div className="flex items-center space-x-3">
                    <svg className="h-5 w-5 text-blue-300 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
