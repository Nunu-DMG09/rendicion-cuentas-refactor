...
export default function RendicionAdminModal({ isOpen, onClose, type, title, message }: Props) {
    const getIcon = () => {
        switch (type) {
            case 'success':
                        ...
                        <div className="p-8">
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div className="text-sm text-gray-600">
                                            ...
                                            <ul className="space-y-1">
                                                <li>• La rendición aparecerá en el calendario público</li>
                                                <li>• Los ciudadanos podrán registrarse</li>
                                                <li>• Recibirá notificaciones de nuevas inscripciones</li>
                                            </ul>
                                        </div>
                                    </div>
                                </motion.div>
                            ...
                            {type !== 'loading' && (
                                <motion.button
                                    onClick={onClose}
                                    className={`
                    cursor-pointer w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-300 cursor-pointer
                    ${type === 'success'
